...
\restrict kADQpfpSclnahtyfhYBDQewFHrXO5WTnFqIju1gnjnMdezxoZzpqRwvFiKksBJV
    ...
    AS $$
      ...
      BEGIN
          ...
          IF p_id_bien_item IS NOT NULL THEN
              SELECT bi.id_bien INTO v_id_bien_final FROM bien_item bi WHERE bi.id_bien_item = p_id_bien_item;
              IF v_id_bien_final IS NULL THEN
                  RAISE EXCEPTION 'No existe bien_item con id=%', p_id_bien_item;
              END IF;
              PERFORM 1 FROM bien_item bi WHERE bi.id_bien_item = p_id_bien_item AND bi.id_bodega = p_id_bodega_origen AND bi.estado_item = 'DISPONIBLE';
              IF NOT FOUND THEN
                  RAISE EXCEPTION 'El bien_item=% no esta DISPONIBLE en la bodega_origen=%', p_id_bien_item, p_id_bodega_origen;
              END IF;
          ELSE
          ...
          CALL sp_registro_crear(
              p_id_tipo_registro_asignacion, p_id_usuario, p_id_empleado,
              NULL, NULL, p_id_bodega_origen, NULL,
              p_numero_acta, p_observaciones, p_id_registro
          );

          IF p_id_bien_item IS NOT NULL THEN
              CALL sp_registro_agregar_detalle(
                  p_id_registro, v_id_bien_final, p_id_bien_item, NULL,
                  1, NULL, NULL,
                  'Asignacion por acta: ' || COALESCE(p_numero_acta,'(sin numero)'),
                  v_id_detalle
              );
          ELSE
              CALL sp_registro_agregar_detalle(
                  p_id_registro, v_id_bien_final, NULL, NULL,
                  p_cantidad, NULL, NULL,
                  'Asignacion por acta: ' || COALESCE(p_numero_acta,'(sin numero)'),
                  v_id_detalle
              );
          END IF;
          ...
          CALL sp_registro_confirmar_y_afectar_stock(
              p_id_registro, p_id_usuario, p_ip_origen, v_id_log_confirm
          );

          INSERT INTO asignacion_bien (
              id_bien, id_empleado, id_registro, tipo_acta, numero_acta,
              fecha_emision_acta, fecha_entrega_bien, fecha_devolucion_bien,
              motivo_asignacion, observaciones_asignacion, firma_digital,
              archivo_pdf, estado_asignacion, fecha_registro
          ) VALUES (
              v_id_bien_final, p_id_empleado, p_id_registro, p_tipo_acta,
              p_numero_acta, p_fecha_emision_acta, NOW(), NULL,
              p_motivo_asignacion, p_observaciones, COALESCE(p_firma_digital, FALSE),
              p_archivo_pdf, 'ACTIVA', NOW()
          ) RETURNING id_asignacion INTO p_id_asignacion;

          IF p_id_bien_item IS NOT NULL THEN
              UPDATE bien_item SET id_empleado = p_id_empleado, estado_item = 'ASIGNADO'
              WHERE id_bien_item = p_id_bien_item;
          END IF;

          CALL sp_log_evento(
              p_id_usuario, 'CREAR_ASIGNACION', 'asignacion_bien', p_id_asignacion,
              p_ip_origen,
              'Asignacion creada. acta=' || COALESCE(p_numero_acta,'(sin numero)') || ' | id_registro=' || p_id_registro::TEXT,
              p_id_log_usuario
          );
      END;
      $$;
...
3	7	1	23	ASIGNACION	\N	\N	2026-04-18 05:00:06.224076	\N	Asignacion de bien		f	\N	ACTIVA	2026-04-18 05:00:06.224076
\.
...
COPY public.bien (id_bien, id_tipo_bien, id_proveedor, id_valor_bien, codigo_inventario, nombre_bien, descripcion_bien, marca, modelo, unidad_medida, es_consumible, requiere_lote, requiere_serie, estado_bien, fecha_registro, fecha_actualizacion, valor_unitario) FROM stdin;
2	\N	\N	\N	PAPEL-A4-001	Resma de papel A4	Resma de papel bond tamaño carta 500 hojas	\N	\N	RESMA	t	f	f	ACTIVO	2026-03-01 21:22:33.78018	\N	0.000
4	\N	\N	\N	BIEN-003	Mouse	\N	\N	\N	\N	f	f	f	ACTIVO	2026-03-24 18:42:21.984902	\N	0.000
5	\N	\N	\N	BIEN-004	Teclado	\N	\N	\N	\N	f	f	f	ACTIVO	2026-03-24 18:42:36.485745	\N	0.000
6	\N	\N	\N	BIEN-005	Monitor	\N	\N	\N	\N	f	f	f	ACTIVO	2026-03-24 18:42:55.726828	\N	0.000
7	\N	\N	\N	BIEN-006	Celular	\N	Samsung	A71	\N	f	f	f	ACTIVO	2026-04-07 18:22:26.020632	\N	5000.000
9	\N	\N	\N	ofgnio	 bikjjg	\N	mkvfk	\N	\N	f	f	f	INACTIVO	2026-04-18 03:23:12.219017	\N	5000.000
8	\N	\N	\N	bien 	manual	\N	sii	niknijd	\N	f	f	f	INACTIVO	2026-04-18 03:14:22.37024	\N	500.000
1	\N	\N	\N	BIEN-001	Laptop Prueba	\N	\N	\N	\N	f	f	f	INACTIVO	2026-03-01 19:48:42.304481	\N	15000.000
10	\N	\N	\N	BIEN-007	iphone	\N	apple	pro max	\N	f	f	f	ACTIVO	2026-04-18 05:40:13.262374	\N	10000.000
11	\N	\N	\N	PAPEL-001	Papel carta	\N	no se 	\N	\N	f	f	f	ACTIVO	2026-04-18 05:41:32.464107	\N	0.000
\.
...
COPY public.historial_reservas (id_historial, id_bodega, id_bien, cantidad, accion, fecha, usuario) FROM stdin;
1	2	1	1	RESERVAR	2026-03-31 18:11:50.088137	sistema
2	2	1	1	RESERVAR	2026-03-31 18:16:17.279751	sistema
3	1	1	2	RESERVAR	2026-03-31 21:37:41.9549	sistema
4	2	1	3	LIBERAR	2026-03-31 21:49:27.766044	sistema
5	1	4	1	RESERVAR	2026-04-07 00:15:48.591323	sistema
6	1	4	1	RESERVAR	2026-04-07 01:45:51.14766	sistema
7	1	2	9	LIBERAR	2026-04-18 03:15:59.187929	admin
8	1	1	15	CONSUMIR	2026-04-18 03:25:23.224098	sistema
9	1	6	2	LIBERAR	2026-04-18 03:33:24.835035	admin
10	1	7	9	LIBERAR	2026-04-18 04:18:41.367542	admin
11	1	7	1	RESERVAR	2026-04-18 04:19:23.39477	sistema
12	1	4	2	LIBERAR	2026-04-18 04:19:39.598271	sistema
13	1	11	10	LIBERAR	2026-04-18 05:42:15.106579	admin
14	1	11	10000	LIBERAR	2026-04-18 05:43:01.428293	admin
15	1	11	10000	LIBERAR	2026-04-18 05:44:22.724651	admin
16	1	11	10001	LIBERAR	2026-04-18 05:46:15.778146	admin
17	1	11	19999	LIBERAR	2026-04-18 05:46:55.468587	admin
18	1	11	20000	LIBERAR	2026-04-18 05:50:52.247834	admin
19	1	11	10000	LIBERAR	2026-04-18 05:51:11.647084	admin
20	1	11	20	LIBERAR	2026-04-18 05:55:06.953413	admin
21	1	11	1000	CONSUMIR	2026-04-18 05:56:01.706418	admin
22	1	11	50000	CONSUMIR	2026-04-18 05:56:34.774447	admin
23	1	11	20	AJUSTE	2026-04-18 05:59:26.091479	admin
24	2	10	15	AJUSTE	2026-04-18 06:06:58.115996	admin
25	1	10	10	AJUSTE	2026-04-18 16:14:32.43731	admin
26	1	11	15	AJUSTE	2026-04-18 16:23:48.586104	admin
\.
...
41	1	6	2.000	0.000	\N	ACTIVO	2026-04-18 03:33:24.835035
27	1	4	11.000	0.000	\N	ACTIVO	2026-04-18 04:19:39.598271
37	1	7	11.000	1.000	\N	ACTIVO	2026-04-18 05:00:06.224076
45	2	10	15.000	0.000	\N	ACTIVO	2026-04-18 06:06:58.115996
46	1	10	10.000	0.000	\N	ACTIVO	2026-04-18 16:14:32.43731
44	1	11	15.000	0.000	\N	ACTIVO	2026-04-18 05:42:15.106579
\.
...
8	3	3	1	1	\N	1	\N	2026-03-02 12:06:24.139427	SOL-1	\N	REGISTRADO	2026-03-02 12:06:24.139427
9	3	3	1	3	\N	1	\N	2026-03-02 12:20:20.73851	SOL-3	\N	REGISTRADO	2026-03-02 12:20:20.73851
7	3	3	1	1	\N	1	\N	2026-03-02 11:56:53.193485	SOL-1	\N	CONFIRMADO	2026-03-02 12:30:53.717268
...
2	1	1	Resmas A4	5.000	Uso administrativo
3	1	1	Resmas A4	5.000	Uso administrativo
...
1	1	1	2	ALTA	Solicitud de papel	2026-03-02 11:52:28.667714	2026-03-02 11:55:55.433843	\n[2026-03-02 11:55] Aprobada por logística
...
4	\N	2	1	BAJA	papel	2026-04-18 04:10:01.983755	\N	\N
5	\N	1	1	URGENTE		2026-04-18 04:23:47.102486	\N	\N
6	\N	2	1	NORMAL		2026-04-18 04:26:18.223762	\N	\N
...
COPY public.usuario (id_usuario, id_empleado, nombre_usuario, contrasena_usuario, correo_login, ultimo_acceso, intentos_fallidos, bloqueado, estado_usuario, fecha_registro) FROM stdin;
12	7	mdiaz	$2b$10$h6X6ccCr3NZLg3iAuVHC2ul.qbbBW03TA0mseXVPJ6n0g/cHoa4f.	mdiaz@didadpol.gob	\N	0	f	ACTIVO	2026-04-12 11:13:39.412007
14	9	dpastrana	$2b$10$uLkIZRyM1WwmLfxfR1aq1eHic9h.USgPlCMtue7xh9jPa0cnEMIDC	dpastrana@didadpol.gob	\N	0	f	ACTIVO	2026-04-12 23:01:02.426693
11	6	jgomez	$2b$10$YCw5rIcr8coDjOmzg3jlE.txeMU8.j74Oc3aBUp8F/G4o.XdkgFHe	jgomez@didadpol.gob	\N	0	f	ACTIVO	2026-04-12 11:10:32.963532
13	8	aberrones	$2b$10$pa/tAmoQHrscvUfv.fyZkOHlhTkaJ0.YOL6pzx1jFo3FrfH52xXeO	aberrones@didadpol.gob	\N	0	f	ACTIVO	2026-04-12 11:17:30.691447
6	5	Carlos prueba1	$2b$10$3rpO3aL2mo/lvZE7d2cud.xR.XsjFsVkWf5vYwO46LAcunc/9IStq	prueba1@mail.com	2026-03-01 15:48:17.971675	0	f	ACTIVO	2026-03-01 07:47:36.977864
3	1	superadmin	$2b$10$bX2VvtmUtKLX3YMx3ivaEuCrd2OHs.D3.xi1vtSlQ4OSuFrdbaMsC	admin@didadpol.gob	2026-04-18 16:11:24.568768	0	f	ACTIVO	2026-02-28 17:09:38.967604
15	10	tyab	$2b$10$Z5j7RFz0zp9xZy4yfSqEsuswqejXfCDNtRmdBZ9ZJaDSIwPcjelUG	tyab@didadpol.gob	\N	0	f	ACTIVO	2026-04-18 02:31:53.660114
\.
...
SELECT pg_catalog.setval('public.asignacion_bien_id_asignacion_seq', 3, true);
...
SELECT pg_catalog.setval('public.bien_id_bien_seq', 11, true);
...
SELECT pg_catalog.setval('public.correo_persona_id_correo_seq', 9, true);
...
SELECT pg_catalog.setval('public.direccion_persona_id_direccion_seq', 9, true);
...
SELECT pg_catalog.setval('public.historial_reservas_id_historial_seq', 26, true);
...
SELECT pg_catalog.setval('public.inventario_id_inventario_seq', 46, true);
...
SELECT pg_catalog.setval('public.log_usuario_id_log_usuario_seq', 566, true);
...
SELECT pg_catalog.setval('public.persona_id_persona_seq', 12, true);
...
SELECT pg_catalog.setval('public.registro_detalle_id_registro_detalle_seq', 13, true);
...
SELECT pg_catalog.setval('public.registro_id_registro_seq', 23, true);
...
SELECT pg_catalog.setval('public.solicitud_logistica_id_solicitud_seq', 6, true);
...
SELECT pg_catalog.setval('public.telefono_persona_id_telefono_seq', 9, true);
...
SELECT pg_catalog.setval('public.usuario_rol_id_usuario_rol_seq', 10, true);
...
\unrestrict kADQpfpSclnahtyfhYBDQewFHrXO5WTnFqIju1gnjnMdezxoZzpqRwvFiKksBJV
