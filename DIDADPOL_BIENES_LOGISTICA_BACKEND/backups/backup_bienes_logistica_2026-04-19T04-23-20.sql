...
\restrict nAysgRkKaAaTfsGruUaHEohWockQSnf7XpwtizPvZU3nUSXsShyoGPpVZ0k3J0g
...
6	10	5	30	ASIGNACION	\N	\N	2026-04-18 22:19:40.217709	\N	Asignacion de bien		f	\N	ACTIVA	2026-04-18 22:19:40.217709
...
46	1	10	10.000	0.000	\N	ACTIVO	2026-04-18 16:37:53.793224
...
3	1	superadmin	$2b$10$kLPAhh31/D.WAmam9y9Kee1LUE/I6qTi0x/7mMLW2AuYPTKZqu.fW	grupoteamaticos@gmail.com	2026-04-18 22:22:05.114554	0	f	ACTIVO	2026-02-28 17:09:38.967604	J6Y95SGX	2026-04-18 18:13:48.027	$2b$10$UPzQ5rS/lRs9Wxh9uStkG.7a7NYmEXPTPCihU4bFJizvkTapYuQku	269697	2026-04-18 18:50:37.159
\.
...
SELECT pg_catalog.setval('public.asignacion_bien_id_asignacion_seq', 6, true);
...
SELECT pg_catalog.setval('public.bien_id_bien_seq', 17, true);
...
SELECT pg_catalog.setval('public.correo_persona_id_correo_seq', 10, true);
...
SELECT pg_catalog.setval('public.historial_reservas_id_historial_seq', 49, true);
...
SELECT pg_catalog.setval('public.inventario_id_inventario_seq', 65, true);
...
SELECT pg_catalog.setval('public.log_usuario_id_log_usuario_seq', 646, true);
...
SELECT pg_catalog.setval('public.mantenimiento_id_mantenimiento_seq', 3, true);
...
SELECT pg_catalog.setval('public.registro_detalle_id_registro_detalle_seq', 19, true);
...
SELECT pg_catalog.setval('public.registro_id_registro_seq', 31, true);
...
SELECT pg_catalog.setval('public.solicitud_logistica_id_solicitud_seq', 9, true);
...
SELECT pg_catalog.setval('public.telefono_persona_id_telefono_seq', 10, true);
...
\unrestrict nAysgRkKaAaTfsGruUaHEohWockQSnf7XpwtizPvZU3nUSXsShyoGPpVZ0k3J0g
